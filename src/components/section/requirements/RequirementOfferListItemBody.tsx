...
import { ModalTypes, OfferState, RequirementState } from "../../../utilities/types";
...
export default function RequirementOfferListItemBody(props: RequirementOfferListItemBodyProps) {
  const [modalCancelPurchaseOrderOpen, setModalCancelPurchaseOrderOpen] = useState(false);
    ...
    <>
      ...
      >
        ...
        <Flex justify="center" gap='small' style={{width: '100%'}}>
          ...
          {
            props.offer.state == OfferState.ACTIVE && props.requirement.state == RequirementState.PUBLISHED && (
              <ButtonContainer 
                text='Elegir oferta'
                type="primary"
      ...
      <ModalContainer
        ...
        data={{offer: props.offer, requirement: props.requirement, offerFilters: props.offerFilters}}
