...
export const MainSocketsContext = createContext<MainSocketsContextType>({
  ...
  connectSingleChatSocket: (_chatId: string) => { }, // Agregado el parámetro para cumplir la firma
  ...
  // SOLUCIÓN AL ERROR DE INTERFAZ:
  chatMessageRead: {
    startMessageId: "", // <-- Agregado para cumplir con la interfaz ChatMessageRead
    endMessageId: ""
  },
